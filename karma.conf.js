...
const SUPPORTED_BROWSERS = ["Chrome", "Edge", "Firefox", "IE", "Opera", "Safari"]
...
module.exports = function(config) {
  config.set({
    ...
    files: ["src/update.test.js", "src/wrapCursor.test.js"],
    ...
    preprocessors: {
      "src/update.test.js": "webpack",
      "src/wrapCursor.test.js": "webpack"
    },
